...
public class PlayerController2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (hit.transform.name == "Player2" && Input.GetKey(KeyCode.Mouse1) && enemyMove.playerTurn == true)
            {
                playerActivate = true;
            }
            if ((hit.transform.name == "Player" || hit.transform.name == "Player3" || hit.transform.name == "Player4") && Input.GetKey(KeyCode.Mouse1))
            {
