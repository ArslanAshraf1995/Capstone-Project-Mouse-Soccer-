...
public class PlayerController4 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (hit.transform.name == "Player4" && Input.GetKey(KeyCode.Mouse1) && enemyMove.playerTurn == true)
            {
                playerActivate = true;
            }
            if ((hit.transform.name == "Player" || hit.transform.name == "Player2" || hit.transform.name == "Player3") && Input.GetKey(KeyCode.Mouse1))
            {
